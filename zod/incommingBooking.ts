...
export const zodIncomingBooking = z.object({
...
}).refine((data) => data.jobDetails.custLocation.longitude !== undefined && data.jobDetails.custLocation.latitude !== undefined, {
    message: "Please allow location access or choose your location",
    path: ["jobDetails.custLocation"],
})

export type zodIncomingBookingType = z.infer<typeof zodIncomingBooking>;